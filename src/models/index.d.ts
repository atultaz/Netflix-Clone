...
export declare class Category {
  ...
  readonly Movies?: (CategoryMovie | null)[];
...
export declare class CategoryMovie {
  readonly id: string;
  readonly category: Category;
  readonly movie: Movie;
  readonly createdAt?: string;
  readonly updatedAt?: string;
  constructor(init: ModelInit<CategoryMovie, CategoryMovieMetaData>);
  static copyOf(source: CategoryMovie, mutator: (draft: MutableModel<CategoryMovie, CategoryMovieMetaData>) => MutableModel<CategoryMovie, CategoryMovieMetaData> | void): CategoryMovie;
}
...
export declare class Movie {
  ...
  readonly categories?: (CategoryMovie | null)[];
  readonly createdAt?: string;
  readonly updatedAt?: string;
